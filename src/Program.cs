        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                if(cmd == "zq")
                {
                    ...
                    zhuaquqi.Zhuaqu(30, url);

                    url = "http://search.51job.com/list/060000,000000,0000,00,9,99,.net,2,2.html?lang=c&stype=1&postchannel=0000&workyear=99&cotype=99&degreefrom=99&jobterm=99&companysize=99&lonlat=0%2C0&radius=-1&ord_field=0&confirmdate=9&fromType=&dibiaoid=0&address=&line=&specialarea=00&from=&welfare=&curr_page={0}";
                    zhuaquqi.Zhuaqu(30, url);
